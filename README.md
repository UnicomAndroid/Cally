...
<p align="center">
  <img src="docs/screenshots/01-home.png" width="220" alt="Список дзвінків">
  <img src="docs/screenshots/02-playback.png" width="220" alt="Плеєр">
  <img src="docs/screenshots/03-transcript.png" width="220" alt="Транскрипт">
  <img src="docs/screenshots/04-settings.png" width="220" alt="Налаштування">
</p>
...
«Для власних цілей» — не автоматичний дозвіл. У one-party consent
юрисдикціях (Україна, UK, більшість США) запис власної розмови для
особистого архіву легальний без сповіщення. У all-party (Німеччина
§ 201 StGB, ~11 штатів США, частина EU) — кримінальна стаття **навіть
для personal use**: GDPR household-exemption тут не рятує, бо це
кримінальне право, а не data-protection. Beep / TTS-announcement у таких
юрисдикціях створює базу для **implied consent** (співрозмовник почув
попередження і продовжив розмову), але сам по собі згодою не є.

**Cally не вміє програти beep / announcement співрозмовнику.** Інжекшен
у voice call uplink — це platform-privileged операція (як у нативному
Pixel Phone з Android 14+, де compliance-disclosure зашитий у системний
додаток). Третій додаток, навіть з shell-UID bypass'ом через Shizuku, до
uplink stream не пише — публічного API немає, а AEC топить
«beep-через-speaker» хаки. Якщо ваша юрисдикція вимагає сповіщення
співрозмовника — Cally **не закриває цю вимогу технічно**, і відповідальність
за legal compliance лежить на користувачі (наприклад, усне попередження
на старті розмови).
